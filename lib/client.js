window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function ContactsPanel({ roster, sessions, openSession, startWithPreset }) {
		...
		*/
		function SidebarShell(props) {
			const { collapsed, startSession, toggleSidebar, openSession, startWithPreset, useRoster, useSessions, renderSlot } = props;
